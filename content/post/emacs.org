...
- [[https://github.com/emacs-evil/evil-surround][evil surround]] : port
  of Tim Pope's surround. Edit parenthesis, quotes, tags... Super useful
  when you need it.
...
- Shell : =eshell= is nice but I prefer a "real" shell (using =nushell=
  at the moment). easier to deal with.
